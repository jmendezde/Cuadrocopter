...
void setup() {
 firstESC.attach(8);    // attached to pin 8 I just do this with 1 Servo
// secondESC.attach(10);    // attached to pin 10 I just do this with 2 Servo
// thirdESC.attach(9);    // attached to pin 9 I just do this with 3 Servo
// fourthESC.attach(11);
  Serial.begin(115200);
...
//        firstESC.writeMicroseconds(value+100);
//        secondESC.writeMicroseconds(value+100);
//        thirdESC.writeMicroseconds(value+100);
//        fourthESC.writeMicroseconds(value+100);
        Serial.print(F("\r\nUp"));
        PS4.setLed(Red);
