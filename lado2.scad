...
module caja_modificada(){
    difference(){
        ...
        translate([ladox/2 -15/2 -20,45,-alturaz/2 +7 +15/2])
            color("green")
                cube([15,15,15],center=true);
        
        translate([ladox/2 -10/2 -52,+55,-alturaz/2 + 10/2 +9])
            rotate ([90,0,0])
                color("red")
                    cylinder(r=10/2, h=15,$fn=500);
        
        translate([-ladox/2 +10/2 +18,-48,-alturaz/2 + 8/2 +12.5])
            rotate ([90,0,0])
                color("blue")
                    cylinder(r=8/2, h=15, center= true);
        
        translate([-ladox/2 +10/2 +18,-49,-alturaz/2 - 18/2 +12.5])
            rotate ([90,0,0])
                color("blue")
